...
public class ActivityAddFriendsForSearchRestaurants extends Activity implements OnClickListener,
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		//iv_backScreenAddFriend.setVisibility(View.INVISIBLE);
	...
	public void onClick(View v) {
		...
		case R.id.btn_searchFriends: {
			...
			btn_searchFriends
					.setImageResource(R.drawable.ic_action_search_while);
					...
					public void onResponse(String response) {
						...
						try {
							...
							for (int i = 0; i < items.length(); i++) {
								...
								friend.setAccount(item.optString("first_name")
							...
							addAdapter = new AddFriendsAdapter(
									ActivityAddFriendsForSearchRestaurants.this,
									R.layout.add_friend_item, arraylistAdd);
							addAdapter.setListener(ActivityAddFriendsForSearchRestaurants.this);
							listviewAdd.setAdapter(addAdapter);
